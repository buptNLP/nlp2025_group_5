...
# NLP课程设计 - 基于LangChain的本地知识库智能检索与问答增强
...
在此，感谢袁老师以及助教学长一学期在NLP课程中的辛勤付出！

同时也致谢CSDN提供的开源社区平台、LangChain提供的RAG框架、BAAI提供的BGE预训练模型以及Github提供的代码仓库！

## 联系方式

如有任何问题，可以通过课程QQ群或者微信联系项目组组长王博远。
